...
export default function ChatPanel({
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", background: "white" }}>
      ...
      {/* Header */}
      <div style={{ padding: "14px 16px", borderBottom: "1px solid #e5e7eb", display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
          ...
          <div key={i} style={{ display: "flex", justifyContent: msg.role === "user" ? "flex-end" : "flex-start" }}>
            {msg.role === "ai" && (
              <div style={{ display: "flex", alignItems: "flex-start", gap: 6 }}>
                ...
                <div style={{ background: "white", border: "1px solid #e5e7eb", borderRadius: "4px 14px 14px 14px", padding: "9px 13px", maxWidth: 220 }}>
